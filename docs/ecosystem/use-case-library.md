...
If your government program fits the GovOps model, submit a [New Jurisdiction issue](https://github.com/agentic-state/GovOps-LaC/issues/new?template=new_jurisdiction.md) with the program details. The community can help encode the rules.
