...
const REPO_BASE =
  ...
  "https://github.com/agentic-state/GovOps-LaC/blob/main";
...
const PROJECT_HOME =
  ...
  "https://agentic-state.github.io/GovOps-LaC/";
        ...
        <div className="flex items-stretch">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <ExternalAnchor href="https://github.com/agentic-state/GovOps-LaC">
                {t("about.cta.github")}
              </ExternalAnchor>
